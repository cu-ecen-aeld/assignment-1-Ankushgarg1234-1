...
void test_validate_my_username()
{
     ...
     */
    const char *username = malloc(14); 
    username = my_username();
    const char *username1 = malloc(14);
    username1 = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username, username1, "PASS");
